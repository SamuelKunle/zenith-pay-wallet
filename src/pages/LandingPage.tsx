...
const testimonials = [
  {
    ...
    text: "Zenith Pay made receiving payments from clients effortless. The transfer speed is unmatched.",
    rating: 5,
  },
  {
    name: "Taylor B.",
    role: "Business Owner · New York",
    text: "The merchant QR and POS tools helped me go cashless at my store. Settlements are fast and reliable.",
    rating: 5,
  },
  {
    name: "Kendall A.",
    role: "Student · Singapore",
    text: "I love the savings goals feature. It keeps me disciplined and the interest rates are actually good.",
    rating: 5,
  },
];
  ...
  return (
    <MotionConfig reducedMotion={prefersReducedMotion ? "always" : "user"}>
      <div className="min-h-screen bg-background">
        {/* ─── Navigation ─── */}
        <nav
          className="sticky top-0 z-50 bg-background/80 backdrop-blur-2xl"
          style={{
        ...
        >
          <div className="max-w-[1200px] mx-auto flex items-center justify-between px-5 md:px-8 h-[56px]">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              >
                <Sun
                  className="h-4 w-4 text-foreground dark:hidden"
                  strokeWidth={1.8}
                />
                <Moon
                  className="h-4 w-4 text-foreground hidden dark:block"
                  strokeWidth={1.8}
                />
              </button>
              <Link
                to="/login"
                className="text-[13px] font-semibold text-foreground hover:text-primary transition-colors duration-150"
              >
                Sign In
              </Link>
              <Link
                to="/signup"
                className="rounded-xl bg-primary px-4 py-2 text-[12px] font-bold text-primary-foreground hover:bg-primary/90 transition-colors duration-150 active:scale-[0.97]"
              >
                Get Started
              </Link>
            </div>
              ...
              >
                <div className="px-5 py-4 space-y-1">
                  ...
                  <div className="flex gap-3 pt-3">
                    <Link
                      to="/login"
                      className="flex-1 rounded-xl border border-surface-border bg-card py-2.5 text-center text-[13px] font-semibold text-foreground"
                    >
                      Sign In
                    </Link>
                    <Link
                      to="/signup"
                      className="flex-1 rounded-xl bg-primary py-2.5 text-center text-[13px] font-bold text-primary-foreground"
                    >
                      Get Started
                    </Link>
                  </div>
        ...
        <section className="relative overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 0%, hsl(var(--primary) / 0.03) 0%, transparent 60%)",
            }}
          />
            ...
            <div className="max-w-[640px] mx-auto text-center lg:text-left lg:mx-0 lg:max-w-none lg:grid lg:grid-cols-[1fr_440px] lg:gap-16 lg:items-center">
              ...
              <div>
                ...
                >
                  ...
                  <h1 className="text-[32px] md:text-[42px] lg:text-[48px] font-extrabold text-foreground leading-[1.08] tracking-[-0.03em] mb-5">
                    The premium way <br className="hidden md:block" />
                    to move money
                  </h1>

                  <p className="text-[15px] md:text-[17px] text-muted-foreground leading-relaxed max-w-[480px] mx-auto lg:mx-0 mb-8">
                    Faster transfers. Smarter cards. Secure savings. Everything
                    you need to manage your money with confidence — in one
                    elegant experience.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row items-center lg:items-start gap-3 mb-10">
                    <Link
                      to="/signup"
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl balance-gradient px-8 py-4 text-[15px] font-bold text-white shadow-balance hover:opacity-95 active:scale-[0.98] transition-all"
                    >
                      Open Free Account
                    ...
                    <Link
                      to="/login"
                      className="w-full sm:w-auto inline-flex items-center justify-center rounded-2xl border border-surface-border bg-card px-8 py-4 text-[14px] font-semibold text-foreground hover:bg-surface-secondary active:scale-[0.98] transition-all"
                    >
                      Sign In
                    </Link>
                  </div>
              ...
              >
                <div className="relative">
                  {/* Phone frame */}
                  <div
                    className="rounded-[2.5rem] bg-card shadow-premium p-3 mx-auto max-w-[280px]"
                    style={{
                    ...
                    >
                      ...
                      <div className="px-4 pb-5 pt-3">
                        ...
                        <div className="balance-gradient rounded-2xl p-4 mb-4 relative overflow-hidden">
                          ...
                          <p className="text-[8px] font-medium text-white/40 uppercase tracking-wider mb-1">
                            Available Balance
                          </p>
                          <p className="text-[20px] font-extrabold text-white tabular-nums mb-3">
                            $1,245,800
                            <span className="text-[10px] opacity-40">.50</span>
                          </p>
                        ...
                        <p className="text-[8px] font-bold text-foreground/40 uppercase tracking-wider mb-2">
                          Recent
                        </p>
                        {[
                          {
                          ...
                          <div
                            ...
                            style={{
                              borderBottom:
                                "1px solid hsl(var(--surface-border-subtle) / 0.5)",
                            }}
                          >
                            ...
                            <span
                              className={`text-[9px] font-bold tabular-nums ${tx.color}`}
                            >
                              {tx.amount}
                            </span>
                          </div>
          ...
          <div className="max-w-[1200px] mx-auto px-5 md:px-8 py-10 md:py-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
              {trustStats.map((stat, i) => (
                ...
                >
                  <p className="text-[28px] md:text-[34px] font-extrabold text-foreground tabular-nums tracking-[-0.02em]">
                    {stat.value}
                  </p>
        ...
        <section
          id="features"
          className="max-w-[1200px] mx-auto px-5 md:px-8 py-20 md:py-28"
        >
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              ...
              <p className="text-[14px] md:text-[15px] text-muted-foreground leading-relaxed mb-8 max-w-md">
                Instant transfers to any bank or wallet worldwide. Transparent
                fees before you send. No hidden charges, no delays.
              </p>
              ...
              <PhoneMockup>
                <div className="px-4 pt-4 pb-6">
                  <div className="text-center py-4 mb-4">
                    <p className="text-[8px] font-medium text-muted-foreground/60 uppercase tracking-widest mb-1">
                      You're sending
                    </p>
                    <p className="text-[26px] font-extrabold text-foreground tabular-nums">
                      $75,000
                    </p>
                  </div>
                  <div
                    className="rounded-xl bg-card p-3 mb-3"
                    style={{
                      border: "1px solid hsl(var(--surface-border-subtle))",
                    }}
                  >
                    <div className="flex items-center gap-2.5 mb-2.5">
                      <div className="h-8 w-8 rounded-full balance-gradient flex items-center justify-center text-[8px] font-bold text-white">
                        AN
                      </div>
                      <div>
                        ...
                        <p className="text-[8px] text-muted-foreground">
                          Global Bank · Verified ✓
                        </p>
                      </div>
                    </div>
                    <div
                      className="flex items-center justify-between text-[8px] pt-2"
                      style={{
                        borderTop:
                          "1px solid hsl(var(--surface-border-subtle))",
                      }}
                    >
          ...
          <div className="max-w-[1200px] mx-auto px-5 md:px-8 py-20 md:py-28">
            <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
                ...
                <div className="max-w-[320px] mx-auto">
                  ...
                  <div className="rounded-2xl bg-gradient-to-br from-[hsl(162_72%_22%)] via-[hsl(170_60%_26%)] to-[hsl(180_50%_18%)] p-5 shadow-elevated aspect-[1.6/1] relative overflow-hidden">
                    ...
                    <div className="flex items-start justify-between mb-auto">
                      <div>
                        <p className="text-[8px] font-medium text-white/35 uppercase tracking-wider">
                          Virtual Card
                        </p>
                    ...
                    <div className="mt-8">
                      <p className="text-[13px] font-semibold text-white/80 tracking-[0.15em] tabular-nums">
                        •••• •••• •••• 4829
                      </p>
                    </div>
                    <div className="flex items-end justify-between mt-4">
                      <div>
                        <p className="text-[7px] text-white/30 uppercase tracking-wider">
                          Card Holder
                        </p>
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[9px] font-semibold text-white/65 tabular-nums">
                          09/27
                        </p>
                      </div>
                    </div>
              ...
              >
                ...
                <p className="text-[14px] md:text-[15px] text-muted-foreground leading-relaxed mb-8 max-w-md">
                  Virtual and physical cards with real-time spending controls.
                  Freeze instantly, set limits by category, and monitor every
          ...
          <div className="text-center mb-14">
            ...
            >
              ...
              <p className="text-[14px] text-muted-foreground max-w-lg mx-auto">
                A complete financial platform designed for speed, security, and
                daily convenience.
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                icon: PiggyBank,
                title: "Savings & Goals",
                desc: "Flexible, locked, and goal-based savings with competitive rates up to 14% p.a.",
                color: "text-success",
                bgColor: "hsl(var(--success) / 0.06)",
              },
              {
                icon: Zap,
                title: "Bills & Utilities",
                desc: "Pay electricity, airtime, data, cable TV and more — fast, reliable, with instant confirmation.",
                color: "text-warning",
                bgColor: "hsl(var(--warning) / 0.06)",
              },
              {
                icon: QrCode,
                title: "QR Payments",
                desc: "Scan to pay at any merchant. Accept payments with your branded business QR code.",
                color: "text-accent",
              ...
              },
              {
                ...
                desc: "Track where your money goes with smart categorisation, weekly reports, and budget alerts.",
                color: "text-info",
                bgColor: "hsl(var(--info) / 0.06)",
              },
              {
                icon: Users,
                title: "Business Tools",
                desc: "Merchant dashboard, sales tracking, staff access controls, and instant settlements.",
                color: "text-primary",
              ...
              },
              {
                icon: Smartphone,
                title: "Multi-Device",
                desc: "Access your account from any device with trusted device management and login alerts.",
                color: "text-foreground",
          ...
          <div className="max-w-[1200px] mx-auto px-5 md:px-8 py-20 md:py-28">
            <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
              ...
              >
                ...
                <p className="text-[14px] md:text-[15px] text-muted-foreground leading-relaxed mb-8 max-w-md">
                  Every layer of Zenith Pay is built to protect your money. From
                  biometric login to real-time fraud monitoring, your safety is
                  always visible.
                </p>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    return (
                      <div
                        key={item.text}
                        className="flex items-center gap-2.5 rounded-xl bg-card p-3"
                        style={{
                          border: "1px solid hsl(var(--surface-border-subtle))",
                        }}
                      >
        ...
        >
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              ...
              <p className="text-[14px] md:text-[15px] text-muted-foreground leading-relaxed mb-8 max-w-md">
                Accept payments, track revenue, manage settlements, and grow
                your business — all from one premium dashboard.
              </p>
              <div className="space-y-3">
                {[
              ...
              <div className="mt-8">
                <Link
                  to="/signup"
                  className="inline-flex items-center gap-2 rounded-2xl bg-primary px-6 py-3 text-[13px] font-bold text-primary-foreground hover:bg-primary/90 active:scale-[0.97] transition-all"
                >
                ...
                {[
                  ...
                  return (
                    <div key={card.title} className="surface-content p-5">
                      ...
                      <p className="text-[20px] font-extrabold text-foreground tabular-nums tracking-[-0.02em]">
                        {card.value}
                      </p>
          ...
          <div className="max-w-[1200px] mx-auto px-5 md:px-8 py-20 md:py-28">
            <div className="text-center mb-14">
              ...
              >
                ...
                <p className="text-[14px] text-muted-foreground max-w-lg mx-auto">
                  Everything you need to know about getting started and staying
                  secure.
                </p>
              </motion.div>
            </div>
            ...
            <div className="max-w-[700px] mx-auto space-y-3">
              {[
                {
                  q: "Is my money safe with Zenith Pay?",
                  a: "Absolutely. All deposits are FDIC-insured up to $5 million. We use bank-grade 256-bit encryption, biometric authentication, and real-time fraud monitoring to protect every account.",
                },
                {
                  q: "How fast are transfers?",
                  a: "Most transfers arrive in under 2 seconds. We process through real-time payment rails for instant bank-to-bank transfers, 24/7 including weekends and holidays.",
                },
                {
                  q: "Are there any hidden fees?",
                  a: "None. We show you the exact fee before you confirm any transaction. Transfers under $5,000 are completely free. All other charges follow standard RTP rates with no markups.",
                },
                {
                  q: "How do I open an account?",
                  a: "It takes about 3 minutes. Download the app, enter your details, verify your identity with a valid ID and selfie, set up your PIN, and you're ready to go.",
                },
                {
                  q: "Can I use Zenith Pay for my business?",
                  a: "Yes. Business accounts include merchant QR codes, real-time sales tracking, staff sub-accounts with role-based access, and instant settlement to your bank account.",
                },
                {
                  q: "What happens if I lose my phone?",
                  a: "Your account remains secure. Biometric login means no one else can access it. You can also freeze your account instantly from any browser, and our support team is available 24/7 to help.",
                },
                {
                  q: "What types of bills can I pay?",
                  a: "Electricity (all utility providers), airtime and data (all networks), cable TV (streaming TV, cable TV, digital TV), internet subscriptions, education fees, and government payments — all with instant confirmation.",
                },
              ].map((faq, i) => (
                <motion.details
                  key={i}
                ...
                >
                  <summary className="flex items-center justify-between cursor-pointer px-6 py-5 list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <ChevronRight
                      className="h-4 w-4 text-muted-foreground shrink-0 transition-transform duration-200 group-open:rotate-90"
                      strokeWidth={2}
                    />
                  </summary>
          ...
          <div className="text-center mb-14">
            ...
            >
              ...
              <p className="text-[14px] text-muted-foreground">
                Real people, real financial confidence.
              </p>
            </motion.div>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="text-[13px] text-foreground leading-relaxed mb-5">
                  "{t.text}"
                </p>
                <div>
          ...
          <div className="rounded-3xl balance-gradient p-8 md:p-14 lg:p-16 text-center relative overflow-hidden shadow-balance">
            ...
            <div className="relative z-10 max-w-lg mx-auto">
              <h2 className="text-[24px] md:text-[34px] font-extrabold text-white tracking-[-0.02em] leading-tight mb-4">
                A premium way <br className="hidden md:block" />
                to bank every day
              </h2>
              <p className="text-[14px] md:text-[15px] text-white/55 leading-relaxed mb-8">
                Join millions of users managing their money with confidence,
                clarity, and complete control.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link
                  to="/signup"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-8 py-4 text-[15px] font-bold text-foreground shadow-elevated hover:bg-white/95 active:scale-[0.98] transition-all"
                >
                  Open Free Account
                  <ArrowRight className="h-4 w-4" strokeWidth={2} />
                </Link>
                <Link
                  to="/login"
                  className="w-full sm:w-auto inline-flex items-center justify-center rounded-2xl border border-white/15 px-8 py-4 text-[14px] font-semibold text-white hover:bg-white/[0.06] active:scale-[0.98] transition-all"
                >
                  Sign In
                </Link>
              </div>
        ...
        {/* ─── Footer ─── */}
        <footer
          style={{ borderTop: "1px solid hsl(var(--surface-border-subtle))" }}
        >
          <div className="max-w-[1200px] mx-auto px-5 md:px-8 py-12 md:py-16">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <p className="text-[11px] text-muted-foreground leading-relaxed max-w-[200px]">
                  A premium digital banking experience for modern users
                  worldwide.
                </p>
              </div>
              ...
              {[
                ...
                <div key={section.title}>
                  <h4 className="text-[10px] font-bold text-foreground uppercase tracking-[0.06em] mb-3">
                    {section.title}
                  </h4>
                  <div className="space-y-2">
                    {section.links.map((link) => {
                      ...
                      return typeof link === "string" ? (
                        <p
                          key={label}
                          className="text-[11px] text-muted-foreground hover:text-foreground cursor-pointer transition-colors duration-150"
                        >
                          {label}
                        </p>
                      ) : (
                        <Link
                          key={label}
                          to={to}
                          className="block text-[11px] text-muted-foreground hover:text-foreground transition-colors duration-150"
                        >
                          {label}
                        </Link>
                      );
            ...
            >
              <p className="text-[10px] text-muted-foreground/70">
                © {new Date().getFullYear()} Zenith Pay Technologies Ltd. All
                rights reserved.
              </p>
...
function FeatureLabel({ text }: { text: string }) {
  return (
    ...
    >
      <span className="text-[10px] font-bold text-primary uppercase tracking-[0.06em]">
        {text}
      </span>
    </div>
  );
...
function PhoneMockup({ children }: { children: React.ReactNode }) {
  return (
    <div className="max-w-[260px] mx-auto">
      <div
        className="rounded-[2.5rem] bg-card shadow-premium p-2.5"
